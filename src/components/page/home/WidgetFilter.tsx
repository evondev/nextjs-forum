...
function WidgetFilter() {
  return (
    <div className="p-2.5 rounded-2xl bg-white flex flex-col gap-2.5 dark:bg-dark3">
...
function WidgetItem({ item }: { item: (typeof widgetFilter)[0] }) {
  return (
    <div className="p-2 flex items-center gap-1.5 cursor-pointer hover:bg-secondary-color-6 rounded-md dark:hover:bg-dark4">
